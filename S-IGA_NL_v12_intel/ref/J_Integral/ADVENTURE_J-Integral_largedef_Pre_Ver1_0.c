...
#define N_STRAIN            6
#define N_STRESS            6
#define MAX_N_ELEMENT       1700000
#define MAX_N_NODE          2000000
...
{
  	int ie, ig, id, in, ic, i, j, k, n, Crack_Front=0;
 	int N_SP, SP;
