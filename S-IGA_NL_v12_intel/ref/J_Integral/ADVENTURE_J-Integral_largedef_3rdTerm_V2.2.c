...
CTOA_Result.datの見方
0 #亀裂端からの節点数
12015	12014 #亀裂先端節点 CTOAを計算するための亀裂面上の節点
0.032856	0.003288	0.100060 #CTOA CTOD(亀裂開口変位) 亀裂進展方向長さ
110.001869	0.000000	0.000000 #亀裂先端節点の座標
109.901809	0.001644	0.000000 #亀裂面上節点の座標
...
Argv[7]:J_result_name
Argv[8]:RR 	(積分領域の半径=RR*亀裂前縁長さ/亀裂前縁要素数)
Argv[9]:z1   (積分領域幅=z1*亀裂前縁長さ/亀裂前縁要素数)
...
void Make_gradients_q2_Tetra_10(int cfn, int nn, double RR, double temp_z1, double temp_z2){
  	...
  	for( i = 0; i < NNodes; i++ )
  	{
    		...
    		q2[i][nn] = 0.0;
    		q2[i][nn]  = ComputeValueQFunc(xx,  yy,  zz, z0,  z2, z1,xxc, yyc, zzc, r0, r1);    //すべての節点に対してq値が入る。
